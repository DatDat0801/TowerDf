...
namespace Lean.Pool
{
	...
	public static class LeanPool
	{
		...
		/// <summary>This allows you to spawn a prefab via GameObject.</summary>
		public static GameObject Spawn(GameObject prefab, Vector3 position, Quaternion rotation, Transform parent = null,int preload = 0)
		{
			if (prefab == null) { Debug.LogError("Attempting to spawn a null prefab."); return null; }
			// if (parent != null)
			// {
			...
			// }
			return Spawn(prefab, position, rotation, prefab.transform.localScale, parent, false,preload);
		}
		...
		public static void SetPersist(GameObject prefab)
		{
			if (prefab != null)
			{
		...
		/// <summary>This allows you to spawn a prefab via GameObject.</summary>
		private static GameObject Spawn(GameObject prefab, Vector3 localPosition, Quaternion localRotation, Vector3 localScale, Transform parent, bool worldPositionStays,int preload = 0)
		{
			if (prefab != null)
			{
				// Find the pool that handles this prefab
