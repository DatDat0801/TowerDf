...
[AddComponentMenu("Navigation/PolyNavAgentMove")]
///Place this on a game object to find it's path
public class PolyNavAgentMove : MonoBehaviour
{
    private Dummy owner;
    ...
    [SerializeField] private PolyNav2D _map = null;
    ...
    private static List<PolyNavAgentMove> allAgents = new List<PolyNavAgentMove>();
    ...
    public Vector2 position
    {
        ...
        set
        {
            var tf = new Vector3(value.x, value.y, transform.position.z) - (Vector3)centerOffset;
            tf.z = tf.y / 10f;
    ...
    void Awake()
    {
        ...
        InvokeProxy.Iinvoke.Invoke(this, SetUpSpeedValue, 0.1f);
    }
    private void SetUpSpeedValue()
    {
        owner = GetComponent<Dummy>();
    ...
    public bool IsPointValidOnMap(Vector2 point)
    {
        //check if goal is valid
        return map.PointIsValid(point);
    }
