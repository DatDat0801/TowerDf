    ...
    public class EnhancedScroller : MonoBehaviour
    {
            ...
            )
        {
            ...
            else
            {
                ...
                // if (dataIndex > _cellViewSizeArray.Count - _activeCellViews.Count)
                // {
                //     
                //     newScrollPosition = newScrollPosition - _scrollRectTransform.rect.width * (_activeCellViews.Count - 1.5f)/_activeCellViews.Count ;
                // }
            }
            ...
            // start tweening
            StartCoroutine(TweenPosition(tweenType, tweenTime, ScrollPosition, newScrollPosition, jumpComplete, dataIndex));
        }
        ...
        /// <returns></returns>
        IEnumerator TweenPosition(TweenType tweenType, float time, float start, float end, Action tweenComplete, int dataIndex = -1)
        {
