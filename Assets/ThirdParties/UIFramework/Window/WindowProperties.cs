...
namespace Zitga.UIFramework
{
    ...
    public class WindowProperties : IWindowProperties
    {
        ...
        [SerializeField] private bool isBgClose;

        [SerializeField] private bool canNotKeyBack;

        public bool IsBgClose
        {
            get => isPopup && isBgClose;
        ...
        public bool CanNotKeyBack
        {
            get => this.canNotKeyBack;
            set => this.canNotKeyBack = value;
        }
