...
namespace Zitga.UIFramework.Editor
{
    public static class UIFrameworkTools
    {
        [MenuItem("Assets/Create/Zitga UI/UI Frame in Scene", priority = 2)]
        public static void CreateUIFrameInScene() {
            CreateUIFrame();
        }
        
        [MenuItem("Assets/Create/Zitga UI/UI Frame Prefab", priority = 1)]
        ...
        private static GameObject CreateUIFrame() {
            ...
            var loadingPanelLayer = CreateRect("LoadingPanelLayer", root, uiLayer);
            ...
            prioList.Add(new PanelPriorityLayerListEntry(PanelPriority.Loading, loadingPanelLayer.transform));
