...
namespace EW2
{
    public class TournamentBuyTicketWindow : AWindowController
    {
        ...
        {
            UIFrame.Instance.CloseWindow(ScreenIds.popup_buy_tournament_ticket);
        }
        ...
        {
            this.txtTitle.text = L.playable_mode.purchase_ticket_popup_title_txt;
            this.txtTip.text = string.Format(L.popup.go_to_shop_question_txt,
                Ultilities.GetNameCurrency(MoneyType.TournamentTicket));
