...
namespace EW2
{
    public class HeroDefenseBarController : MonoBehaviour, IEnhancedScrollerDelegate
    {
        public SelectHeroDefendModeWindow selectHeroDefendModeWindow;
            ...
            foreach (var heroCollectionInfo in heroCollection)
            {
                ...
                if (isUnlocked)
                {
                    ...
                    var heroData = new HeroBarData {
                        ...
                        level = level,
                        Selected = selectHeroDefendModeWindow.IsHeroSelected(heroCollectionInfo.heroId)
                    };
        ...
        {
            if (selectHeroDefendModeWindow.CanAddHero())
            {
                heroData.Selected = true;
                selectHeroDefendModeWindow.AddHero(new HeroSelectedData {
        ...
        private void OnHeroUnselected(HeroBarData heroData)
        {
            ...
            selectHeroDefendModeWindow.RemoveHero(heroData.heroId);
        }
    }
}