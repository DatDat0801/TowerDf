...
namespace EW2
{
    public class Enemy3020Skill1 : SkillEnemy
    {
        private Enemy3020 enemy;
        private EnemyData3020.EnemyData3020Skill1 skillData;
        ...
        public override void Init(EnemyBase enemyBase)
        {
            ...
            if (skillData == null)
                skillData = GameContainer.Instance.Get<UnitDataBase>().Get<EnemyData3020>().GetSkill1(enemyBase.Level);
        ...
        public override void CastSkill()
        {
            ...
            {
                var impact = ResourceUtils.GetVfx("Enemy", "3020_skill_1_impact", target.transform.position,
                    Quaternion.identity);

                if (impact != null)
                {
                    impact.GetComponent<Enemy3020Skill1Impact>().InitImpact(enemy, skillData);
                }
            }
        }
        ...
        private List<Dummy> CalculateAllTarget()
        {
            ...
            foreach (var target in enemy.RangeDetectAllMap.CalculateAllTarget())
            {
