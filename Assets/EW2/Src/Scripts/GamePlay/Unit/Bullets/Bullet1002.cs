...
namespace EW2
{
    public class Bullet1002 : BulletTrail
    {
        ...
        public void InitBullet1002(Unit shooter, Unit target, float timeFly, Action<Unit> onFlyFinish = null)
        {
        ...
        void OnTriggerEnter2D(Collider2D other)
        {
            ...
            if (bodyCollider != null)
            {
                ...
                if (enemy == target)
                {
                    ...
                    var goEffect = ResourceUtils.GetVfxHero("1002_archer_impact", Vector3.zero,
