...
namespace EW2
{
    public class HeroAcademyCheckinEvent : IEventQuest
    {
        ...
        {
            mapQuest.Clear();
            var checkinData = GameContainer.Instance.Get<EventDatabase>().Get<HeroAcademyCheckIn>();

            foreach (var questInfo in checkinData.heroAcademyCheckInDatas)
            {
