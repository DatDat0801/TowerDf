...
namespace AppsFlyerSDK
{
    public class AppsFlyer : MonoBehaviour
    {
        ...
        public static void ValidateAndSendInAppPurchaseAndroid(string signature, string purchaseData, string price,
            string currency, Dictionary<string, string> additionalParameters, MonoBehaviour go)
        {
            string publicKey =
                "";
        ...
        public static void ValidateAndSendInAppPurchaseIos(string productIdentifier, string price, string currency,
